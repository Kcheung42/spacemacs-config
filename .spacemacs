...
values."
  (setq-default
   ...
   '(
     ...
     (cmake :variables cmake-tab-width 4)
     (git :variables git-enable-magit-todos-plugin t)
     (java :variables java-backend 'eclim eclim-eclipse-dirs '("~/eclipse/") eclim-executable "~/eclipse/plugins/org.eclim_2.8.0/bin/eclim")
...
you should place your code here."
    ...
    ;; Fix for "Invalid image type 'xpm'" error
    ...
    ;;       (append '("node_modules" ".shadow-cljs" "build")
    ;;               projectile-globally-ignored-directories))


    ;; (push "/home/kcheung/public-githubs/css-sort" load-path)
    ;; (require 'css-sort)
    ...
    (add-to-list 'helm-grep-ignored-directories "resource/public/js")
    ...
    ;; fix yas-snippet-dir
    ;;(setq yas-snippet-dirs '("/home/kcheung/.emacs.d/elpa/develop/yasnippet-snippets-20230314.2056/snippets"))
    (add-to-list 'yas-snippet-dirs (symbol-value 'yasnippet-snippets-dir))


    ;; manage savehist so spacemacs does not take up too much memory
    ...
    ;; Fix for SPC SPC not working
    (spacemacs/set-leader-keys "SPC" 'helm-M-x)

    (global-set-key (kbd "M-y") 'helm-show-kill-ring)
    (global-set-key (kbd "<f5>") (lambda() (interactive) (find-file "~/org/todo/agenda.org")))

    (global-set-key (kbd "<f8>") 'calc)
    (global-set-key (kbd "<f9>") (lambda () (setq clojure-indent-style "always-align")))
    (global-set-key (kbd "<f11>") 'zoom-window-zoom)
    (define-key vterm-mode-map (kbd "<f11>") #'zoom-window-zoom)
...
This function is called at the very end of Spacemacs initialization."
  ...
  (custom-set-variables
   ...
   ;; If there is more than one, they won't work right.
   '(package-selected-packages
     '(ghub closql treepy zoom-window zenburn-theme zen-and-art-theme yapfify yaml-mode xterm-color ws-butler winum white-sand-theme which-key web-mode web-beautify vterm volatile-highlights vmd-mode vi-tilde-fringe uuidgen use-package unfill undo-tree underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme toc-org tern tao-theme tangotango-theme tango-plus-theme tango-2-theme tagedit systemd sunny-day-theme sublime-themes subatomic256-theme subatomic-theme sqlite3 sql-indent spaceline spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smeargle slim-mode shell-pop seti-theme scss-mode sass-mode rvm ruby-tools ruby-test-mode rubocop rspec-mode robe rjsx-mode reverse-theme restart-emacs rebecca-theme rbenv rake rainbow-delimiters railscasts-theme pyvenv pytest pyenv-mode py-isort purple-haze-theme pug-mode professional-theme prettier-js popwin planet-theme pip-requirements phoenix-dark-pink-theme phoenix-dark-mono-theme persp-mode paradox orgit organic-green-theme org-projectile org-preview-html org-present org-pomodoro org-plus-contrib org-mime org-journal org-download org-chef org-bullets open-junk-file omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme ob-mermaid nodejs-repl noctilux-theme nginx-mode neotree naquadah-theme mwim mustang-theme multi-term move-text monokai-theme monochrome-theme molokai-theme moe-theme mmm-mode minitest minimal-theme material-theme markdown-toc magit-gitflow madhat2r-theme macrostep lush-theme lorem-ipsum livid-mode live-py-mode linum-relative link-hint light-soap-theme json-mode js2-refactor js-doc jbeans-theme jazz-theme ir-black-theme inkpot-theme indent-guide hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers highlight-indentation heroku-theme hemisu-theme helm-themes helm-swoop helm-pydoc helm-projectile helm-mode-manager helm-make helm-gitignore helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag hc-zenburn-theme gruvbox-theme gruber-darker-theme graphviz-dot-mode graphql-mode grandshell-theme gotham-theme google-translate golden-ratio gnuplot gmail-message-mode git-timemachine git-messenger git-link git-commit gh-md gandalf-theme fuzzy flyspell-popup flyspell-correct-helm flymd flycheck-pos-tip flx-ido flatui-theme flatland-theme fill-column-indicator fancy-battery eyebrowse expand-region exotica-theme exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-args evil-anzu espresso-theme eshell-z eshell-prompt-extras esh-help emmet-mode emacsql-sqlite elpher elisp-slime-nav edit-server dumb-jump dracula-theme dockerfile-mode docker-tramp docker django-theme disaster diminish define-word darktooth-theme darkokai-theme darkmine-theme dakrone-theme cython-mode cyberpunk-theme csv-mode crdt company-web company-statistics company-emacs-eclim company-c-headers company-anaconda column-enforce-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized coffee-mode cmake-mode clues-theme clojure-snippets clj-refactor clean-aindent-mode clang-format cider-eval-sexp-fu chruby cherry-blossom-theme busybee-theme bundler bubbleberry-theme birds-of-paradise-plus-theme badwolf-theme auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes aggressive-indent afternoon-theme adoc-mode adaptive-wrap ace-window ace-link ace-jump-helm-line ac-ispell)))
  (custom-set-faces
   ;; custom-set-faces was added by Custom.
   ;; If you edit it by hand, you could mess it up, so be careful.
   ;; Your init file should contain only one such instance.
