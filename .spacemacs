...
values."
  (setq-default
   ...
   '(
     ...
     csv
     docker
     emacs-lisp (shell :variables shell-default-shell 'vterm shell-default-position 'bottom)
     helm
     html
     mermaid
     multiple-cursors
